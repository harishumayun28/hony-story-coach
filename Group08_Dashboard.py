...
Rewrite applying these suggestions. Keep Brandon Stanton's voice — first person, conversational, intimate. Do not invent facts. Under 400 words if longer. Add 1-2 direct quotes if none exist. Return only the rewritten story."""
